...
namespace Feeler\Base\Math\Functions;

use Feeler\Base\Math\Probability\Combinatorics;
...
class Special
{
     ...
     * The original Feeler\Base\Math implementation was based on the textbook mathematical formula, but this led to numerical
