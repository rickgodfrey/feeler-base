...
namespace Feeler\Base\Math\Statistics\Multivariate;

use Feeler\Base\Math\Exception;
use Feeler\Base\Math\Functions\Map\Single;
use Feeler\Base\Math\LinearAlgebra\Eigenvalue;
use Feeler\Base\Math\LinearAlgebra\NumericMatrix;
use Feeler\Base\Math\LinearAlgebra\MatrixFactory;
use Feeler\Base\Math\LinearAlgebra\Vector;
use Feeler\Base\Math\Probability\Distribution\Continuous\F;
use Feeler\Base\Math\Probability\Distribution\Continuous\StandardNormal;
use Feeler\Base\Math\Statistics\Descriptive;
